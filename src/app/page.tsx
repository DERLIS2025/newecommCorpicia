    ...
    <div className="bg-white">
      <section className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-6 md:py-12">
          <div className="grid gap-4 lg:grid-cols-[2fr_1fr]">
            {primaryBanner && (
              <Card className="overflow-hidden border border-gray-200 rounded-xl hover:shadow-md transition-shadow min-h-[240px] md:min-h-[380px]">
                <CardContent className="p-0 h-full">
                  <div className="relative h-full min-h-[240px] md:min-h-[380px]">
                    <Image
                    ...
                    <div className="relative z-10 p-5 md:p-10 h-full flex flex-col justify-end text-white">
                      ...
                      <h1 className="text-2xl md:text-5xl font-bold leading-tight max-w-2xl">{primaryBanner.title}</h1>
                      <p className="mt-2 text-sm md:text-base text-white/90 max-w-xl line-clamp-2 md:line-clamp-none">{primaryBanner.subtitle}</p>
                      <Link href={primaryBanner.link} className="mt-4 md:mt-6">
      ...
      <section className="py-6 bg-white md:hidden">
        <div className="container mx-auto px-4">
          <div className="flex overflow-x-auto gap-3 pb-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            {categories.map((category) => (
              <Link key={category.name} href={category.href} className="shrink-0">
                <Card className="bg-white border border-gray-200 rounded-xl">
                  <CardContent className="px-4 py-3">
                    <p className="text-sm font-medium text-gray-900 whitespace-nowrap">{category.name}</p>
                  </CardContent>
                </Card>
              </Link>
            ))}
      ...
      <section className="py-6 bg-white md:hidden">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/productos/" className="text-corpicia-green text-sm font-medium">
              Ver todos
            </Link>
          </div>
      ...
      <section className="hidden md:block py-14 md:py-16 bg-[#f5f5f5]">
        <div className="container mx-auto px-4">
